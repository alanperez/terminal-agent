 ...
 * Provide tools (like webSearch) may return messages with formats that cause issues when passed back to subsequent API calls.
 */
...
export const filterCompatibleMessages = (
    ...
    return messages.filter((msg) => {
        ...
        // Keep assistant messages that have context
        if(msg.role === "assistant") {
            ...
            // Check content array for text parts
