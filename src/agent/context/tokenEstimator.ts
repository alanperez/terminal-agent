...
/**
 * Estimate token count from text using character division
 * Uses 3.75 as the divisor (midpoint of 3.5 - 4 range)
 * This is approximation, not the exact token
 */
 ...
 * Handles different message contents formats (string, array, objects)
 */
