...
/**
 * Create a mock listFiles tool that returns fixed file list
 */
export const createMockListFiiles = ( mockFiles: string[] ) =>
    tool({
        description:
...
/**
 * Create a mock shell command tool that returns afixed output.
 */
