...
/**
 * Input data for a single turn tool selection evaluations
 * Tests whether the LLM selectsd the correct tools without executing them.
 */
export interface EvalData {
    ...
    systemPrompt?: string;
    // Tool names to make available for the eval
    tools: string[];
    // Configuration for the LLM to call
    config?: {
        model?: string;
        temperature?: number;
    }
